        ...
        <>
            <div className="flex bg-gray-100 min-h-screen">
                <aside className="hidden sm:flex sm:flex-col">
                    ...
                    <div className=" flex flex-col h-screen justify-between text-gray-500 bg-gray-800">
                        <nav className="flex flex-col mx-4 my-6 space-y-4">
                            ...
                            <a href="/home" className="inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
                        ...
                        <div className="flex flex-shrink-0 items-center ml-auto">
                            <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
                                ...
                                <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
                                    <span className="font-semibold">Priya Sweety</span>
                        ...
                        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="block text-gray-500">Total Boats</span>
                                </div>
                            </div>
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="block text-gray-500">Average Rentals</span>
                                </div>
                            </div>
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                            ...
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="block text-gray-500">Referals</span>
                                </div>
                            </div>
                        </section>
                        <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                            <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                                <div className="px-6 py-5 font-semibold border-b border-gray-100">The number of registered users per month</div>
                            ...
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="block text-gray-500">Bookings left</span>
                                </div>
                            </div>
                            <div className="flex items-center p-8 bg-white shadow rounded-lg">
                                ...
                                <div>
                                    ...
                                    <span className="block text-gray-500">Time spent by Users</span>
                                </div>
                            </div>
